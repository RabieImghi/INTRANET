...
<div class="shadow-lg rounded-lg">
    <div class="headerContact px-5 py-5 flex justify-between items-center bg-white border-b-2">
    ...
    <div class="flex flex-row justify-between bg-white">
      <div class="userChat flex flex-col w-2/5 border-r-2 overflow-y-auto">
      ...
      <!-- end message -->
      <div class=" userChat w-2/5 border-l-2 px-5">
