<template>
  ...
  <h3 class="text-2xl font-extrabold"><span class="first">  DEPARTEMENT</span><span class="second"> QUALITE </span></h3>
    <div class="flex mt-8">
      <div class="parent overlay1 hover-zoom mx-4 relative w-96 h-64 flex flex-col justify-center items-center">
        <img src="@/assets/QHSE.jpg" alt="Image 1" class="w-full h-full object-cover absolute inset-0 z-10">
        <div class="overlay-content p-4 text-center relative z-20">
          <h3 class="mt-2 text-lg text-slate-100 font-extrabold">QHSE</h3>
        </div>
      </div>
      ...
      <div class="parent overlay1 hover-zoom mx-4 relative w-96 h-64 flex flex-col justify-center items-center">
        ...
        <div class="overlay-content p-4 text-center relative z-20">
          <h3 class="mt-2 text-lg text-slate-100 font-extrabold">Fiche technique Matériel</h3>
        </div>
      </div>
